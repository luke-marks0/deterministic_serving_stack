...
class TestManifestParsesRealManifest(unittest.TestCase):
    ...
    def test_parses_real_manifest(self) -> None:
        ...
        self.assertEqual(m.hardware_profile.gpu.model, "H100-PCIe-80GB")
        self.assertEqual(m.hardware_profile.gpu.count, 1)
        self.assertEqual(m.hardware_profile.gpu.driver_version, "550.54.15")
        self.assertEqual(m.hardware_profile.gpu.cuda_driver_version, "12.4")
